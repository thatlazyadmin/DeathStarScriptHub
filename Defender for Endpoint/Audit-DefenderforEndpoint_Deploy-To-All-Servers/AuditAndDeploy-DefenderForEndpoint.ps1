<#
.SYNOPSIS
    Audit and install Microsoft Defender for Endpoint on all Windows Server versions.
...
$results | Export-Csv -Path "DefenderForEndpointAudit_AllServers.csv" -NoTypeInformation

# Display final summary
Write-Host "Audit and installation complete. Results exported to DefenderForEndpointAudit_AllServers.csv" -ForegroundColor Green
